# https://github.com/schizofox/schizofox/blob/main/flake/modules/common/firefox/userContent.nix
{ config, ... }:
let
...
in
{
  programs.librewolf.profiles.default.userContent = userContent;
}
