...
pref("browser.phoenix.version", "2025.11.07.1"); // was , locked);
...
pref("app.support.vendor", "Phoenix: 2025.11.07.1"); // was , locked); // [NO-MAIL] [HIDDEN] `about:support` -> `Version`
pref("distribution.about", "Phoenix for Mozilla Firefox - 2025.11.07.1 💜"); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] `about:preferences#general` -> `Firefox Updates` - `distribution.id` and `distribution.version` must be set for this to display, see details below
...
pref("distribution.id", "default"); // was , locked); // [LINUX-ONLY] [HIDDEN]
pref("distribution.version", "default"); // was , locked); // [LINUX-ONLY] [HIDDEN]
...
pref("general.aboutConfig.enable", true); // was , locked); // [DEFAULT - non-Android]
...
pref("browser.policies.perUserDir", false); // was , locked); // [LINUX-ONLY] [NO-MAIL] RedHat/Fedora-specific
pref("toolkit.policies.perUserDir", false); // was , locked); // [HIDDEN] [DEFAULT]
...
pref("browser.engagement.ctrlTab.has-used", true); // was , locked); // [HIDDEN - Android/Thunderbird]
pref("browser.engagement.downloads-button.has-used", true); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.engagement.fxa-toolbar-menu-button.has-used", true); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.engagement.home-button.has-used", true); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.engagement.library-button.has-used", true); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.engagement.sidebar-button.has-used", true); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.engagement.total_uri_count.pbm", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] [DEFAULT]
pref("browser.engagement.search_counts.pbm", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] [DEFAULT]
pref("browser.search.totalSearches", 100); // was , locked); // [NO-ANDROID] [NO-MAIL] https://searchfox.org/firefox-main/rev/a7d872e9/browser/components/urlbar/UrlbarInput.sys.mjs#3193
...
pref("toolkit.coverage.enabled", false); // was , locked); // [DEFAULT] [HIDDEN - Android/Thunderbird]
pref("toolkit.coverage.endpoint.base", ""); // was , locked); // [DEFAULT - Android/Thunderbird] [HIDDEN - Android/Thunderbird]
pref("toolkit.coverage.log-level", 70); // [HIDDEN] Limits logging to fatal only
pref("toolkit.coverage.opt-out", true); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.coverage.opt-out", true); // was , locked); // [HIDDEN]
...
pref("asanreporter.apiurl", ""); // was , locked); // [HIDDEN - non-MOZ_ASAN_REPORTER builds] [DEFAULT - non-MOZ_ASAN_REPORTER builds]
pref("asanreporter.clientid", "unknown"); // was , locked); // [HIDDEN - non-MOZ_ASAN_REPORTER builds] [DEFAULT]
pref("asanreporter.loglevel", 70); // [HIDDEN]
pref("breakpad.reportURL", ""); // was , locked);
pref("browser.crashReports.crashPull", false); // was , locked); // [DEFAULT] Do not request crash reports for background processes from users https://firefox.settings.services.mozilla.com/v1/buckets/main/collections/crash-reports-ondemand/changeset?_expected=0
pref("browser.crashReports.requestedNeverShowAgain", true); // was , locked); // Do not request crash reports for background processes from users https://searchfox.org/mozilla-central/source/toolkit/components/crashes/RemoteSettingsCrashPull.sys.mjs
pref("browser.crashReports.unsubmittedCheck.autoSubmit2", false); // was , locked); // [NO-ANDROID] [HIDDEN - Thunderbird] [DEFAULT]
pref("browser.crashReports.unsubmittedCheck.enabled", false); // was , locked); // [NO-ANDROID] [HIDDEN - Thunderbird] [DEFAULT - non-Nightly]
pref("browser.tabs.crashReporting.includeURL", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] [DEFENSE IN DEPTH] (This is for `about:tabcrashed`)
pref("browser.tabs.crashReporting.sendReport", false); // was , locked); // [NO-ANDROID] [NO-MAIL] (This is for `about:tabcrashed`)
pref("toolkit.crashreporter.include_context_heap", false); // was , locked); // [DEFAULT - non-Nightly]
...
pref("browser.aboutwelcome.entrypoint", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] [DEFAULT] Ensure entrypoint to `about:welcome` is not recorded and ex. submitted for telemetry https://searchfox.org/firefox-main/rev/a7d872e9/browser/components/aboutwelcome/actors/AboutWelcomeChild.sys.mjs#266
pref("browser.safebrowsing.features.emailtracking.datacollection.update", false); // was , locked); // [HIDDEN] https://searchfox.org/mozilla-central/source/toolkit/components/url-classifier/SafeBrowsing.sys.mjs
pref("captchadetection.actor.enabled", false); // was , locked); // Disable CAPTCHA Detection Pings https://searchfox.org/mozilla-central/source/toolkit/components/captchadetection
pref("captchadetection.hasUnsubmittedData", false); // was , locked); // [HIDDEN] Disable CAPTCHA Detection Pings https://searchfox.org/mozilla-central/source/toolkit/components/captchadetection/CaptchaDetectionPingUtils.sys.mjs
pref("captchadetection.loglevel", "Off");
pref("datareporting.dau.cachedUsageProfileID", "beefbeef-beef-beef-beef-beeefbeefbee"); // was , locked); // [HIDDEN] https://searchfox.org/mozilla-central/source/toolkit/components/telemetry/app/ClientID.sys.mjs#44
pref("datareporting.dau.cachedUsageProfileGroupID", "b0bacafe-b0ba-cafe-b0ba-cafeb0bacafe"); // was , locked); // [HIDDEN] https://searchfox.org/mozilla-central/source/toolkit/components/telemetry/app/ClientID.sys.mjs#44
pref("datareporting.healthreport.uploadEnabled", false); // was , locked); // [DEFAULT - Android] Required for Firefox Labs on Desktop
pref("datareporting.policy.dataSubmissionEnabled", false); // was , locked);
pref("datareporting.policy.dataSubmissionPolicyBypassNotification", true); // was , locked); // [DEFAULT - non-MOZILLA_OFFICIAL builds]
pref("datareporting.policy.firstRunURL", ""); // was , locked);
pref("datareporting.usage.uploadEnabled", false); // was , locked); // [HIDDEN - ANDROID] [DEFAULT - Android] Disables "daily usage pings" https://support.mozilla.org/kb/usage-ping-settings
pref("dom.security.unexpected_system_load_telemetry_enabled", false); // was , locked); // [DEFAULT - non-Nightly]
pref("extensions.dataCollectionPermissions.enabled", false); // was , locked); // https://searchfox.org/mozilla-central/source/toolkit/locales-preview/dataCollectionPermissions.ftl
pref("extensions.telemetry.EnvironmentAddonBuilder", false); // was , locked); // [HIDDEN - non-Android] [NIGHTLY] Do not use Glean for add-on telemetry https://bugzilla.mozilla.org/show_bug.cgi?id=1981496 https://searchfox.org/firefox-main/rev/d285a4fb/toolkit/mozapps/extensions/AddonManager.sys.mjs#4801
pref("network.jar.record_failure_reason", false); // was , locked); // [DEFAULT - non-Nightly] https://searchfox.org/mozilla-release/source/modules/libpref/init/StaticPrefList.yaml#14397
pref("network.traffic_analyzer.enabled", false); // was , locked); // https://searchfox.org/mozilla-release/source/modules/libpref/init/StaticPrefList.yaml#13191
pref("network.trr.confirmation_telemetry_enabled", false); // was , locked);
pref("nimbus.telemetry.targetingContextEnabled", false); // was , locked); // [HIDDEN - ANDROID/THUNDERBIRD] [DEFAULT - Artifact builds] Targeting context telemetry - https://searchfox.org/mozilla-central/rev/f1e32fa7/browser/app/profile/firefox.js#2040
pref("privacy.imageInputTelemetry.enableTestMode", false); // was , locked); // [HIDDEN] "Event Telemetry" https://searchfox.org/mozilla-central/source/modules/libpref/init/StaticPrefList.yaml#15549
pref("privacy.trackingprotection.emailtracking.data_collection.enabled", false); // was , locked);
pref("telemetry.fog.aboutGlean.debugTag", ""); // was , locked); // [NO-ANDROID] [HIDDEN] Do not set a debug ping tag https://searchfox.org/firefox-main/rev/4258ca07/toolkit/content/aboutGlean.js#122
pref("telemetry.fog.artifact_build", false); // was , locked); // [DEFAULT - non-Artifact builds] Disable JOG to prevent runtime registration of metrics https://firefox-source-docs.mozilla.org/toolkit/components/glean/dev/jog.html https://firefox-source-docs.mozilla.org/toolkit/components/glean/dev/preferences.html#internal-preferences
pref("telemetry.fog.test.activity_limit", -1); // was , locked); // Disable activity-based ping submission - ex. https://mozilla.github.io/glean/book/user/pings/baseline.html#scheduling
pref("telemetry.fog.test.inactivity_limit", -1); // was , locked); // Disable inactivity-based ping submission - ex. https://mozilla.github.io/glean/book/user/pings/baseline.html#scheduling
pref("telemetry.fog.init_on_shutdown", false); // was , locked); // Prevent Glean from initializing on shutdown https://searchfox.org/mozilla-central/source/toolkit/components/glean/docs/dev/preferences.md#49
pref("telemetry.fog.test.localhost_port", 70000); // was , locked); // Force telemetry pings to be sent to localhost instead of Mozilla's servers, if they're somehow enabled... (port just has to be higher than 0, I chose 70000 as its invalid) - https://searchfox.org/mozilla-central/source/toolkit/components/glean/docs/dev/preferences.md#15
pref("telemetry.glean.internal.finalInactive", false); // was , locked); // [HIDDEN] [DEFAULT] Disable early shutdown pings https://searchfox.org/mozilla-central/source/toolkit/components/glean/xpcom/FOG.cpp
pref("telemetry.glean.internal.maxPingsPerMinute", 0); // was , locked); // [HIDDEN] Prevent Glean from sending pings https://searchfox.org/mozilla-central/source/toolkit/components/glean/xpcom/FOG.cpp
pref("telemetry.number_of_site_origin.min_interval", 999999999); // was , locked);
pref("toolkit.content-background-hang-monitor.disabled", true); // was , locked); // BHR https://searchfox.org/mozilla-central/source/modules/libpref/init/StaticPrefList.yaml#16720
pref("toolkit.telemetry.archive.enabled", false); // was , locked); // [HIDDEN - Android]
pref("toolkit.telemetry.bhrPing.enabled", false); // was , locked); // [HIDDEN - Android]
pref("toolkit.telemetry.cachedClientID", "c0ffeec0-ffee-c0ff-eec0-ffeec0ffeec0"); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.cachedProfileGroupID", "decafdec-afde-cafd-ecaf-decafdecafde"); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.collectInterval", 999999999); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.dap.helper.hpke", ""); // was , locked);
pref("toolkit.telemetry.dap.helper.url", ""); // was , locked);
pref("toolkit.telemetry.dap.leader.hpke", ""); // was , locked);
pref("toolkit.telemetry.dap.leader.url", ""); // was , locked);
pref("toolkit.telemetry.dap.logLevel", "Off");
pref("toolkit.telemetry.dap_enabled", false); // was , locked); // [DEFAULT]
pref("toolkit.telemetry.dap_task1_enabled", false); // was , locked); // [DEFAULT]
pref("toolkit.telemetry.dap_task1_taskid", ""); // was , locked); // [DEFAULT]
pref("toolkit.telemetry.dap_visit_counting_enabled", false); // was , locked); // [DEFAULT]
pref("toolkit.telemetry.dap_visit_counting_experiment_list", "[]"); // was , locked); // [DEFAULT]
pref("toolkit.telemetry.debugSlowSql", false); // [DEFAULT]
pref("toolkit.telemetry.enabled", false); // was , locked);  // [DEFAULT - non-Nightly]
pref("toolkit.telemetry.eventping.maximumFrequency", 999999999); // was , locked); // [HIDDEN] Disable `event` pings
pref("toolkit.telemetry.eventping.minimumFrequency", 999999999); // was , locked); // [HIDDEN] Disable `event` pings
pref("toolkit.telemetry.firstShutdownPing.enabled", false); // was , locked); // [HIDDEN - Android]
pref("toolkit.telemetry.healthping.enabled", false); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.initDelay", 999999999); // was , locked); // [HIDDEN] Prevent the Telemetry component from initializing
...
pref("toolkit.telemetry.minSubsessionLength", 999999999); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.newProfilePing.delay", 999999999); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.newProfilePing.enabled", false); // was , locked); // [HIDDEN - Android]
pref("toolkit.telemetry.overrideUpdateChannel", "release"); // was , locked); // [HIDDEN] [DEFENSE IN DEPTH] Always report channel as `release`, regardless of actual value https://docs.telemetry.mozilla.org/concepts/channels/channel_normalization
pref("toolkit.telemetry.previousBuildID", ""); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.reportingpolicy.firstRun", false); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.scheduler.idleTickInterval", 999999999); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.scheduler.tickInterval", 999999999); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.send.overrideOfficialCheck", false); // was , locked); // [HIDDEN] [DEFAULT] Never send pings on unofficial builds - https://firefox-source-docs.mozilla.org/toolkit/components/telemetry/internals/preferences.html
pref("toolkit.telemetry.server", "data;"); // was , locked);
pref("toolkit.telemetry.server_owner", ""); // was , locked);
pref("toolkit.telemetry.shutdownPingSender.backgroundtask.enabled", false); // was , locked); // [HIDDEN - Android/Thunderbird] [DEFAULT - desktop Firefox]
pref("toolkit.telemetry.shutdownPingSender.enabled", false); // was , locked); // [HIDDEN - Android]
pref("toolkit.telemetry.shutdownPingSender.enabledFirstSession", false); // was , locked); // [HIDDEN - Android] [DEFAULT]
pref("toolkit.telemetry.testing.disableFuzzingDelay", false); // was , locked); // [HIDDEN] [DEFAULT] [DEFENSE IN DEPTH] Always delay sending pings between 0-1 AM
pref("toolkit.telemetry.testing.overridePreRelease", false); // was , locked); // [HIDDEN] [DEFAULT] Never record extended/prelease data on release channels - https://firefox-source-docs.mozilla.org/toolkit/components/telemetry/internals/preferences.html
pref("toolkit.telemetry.testing.overrideProductsCheck", false); // was , locked); // [DEFAULT] Limit probes to only what is supported on the current product - https://firefox-source-docs.mozilla.org/toolkit/components/telemetry/internals/preferences.html
pref("toolkit.telemetry.testing.suppressPingsender", true); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.translations.logLevel", "Off");
pref("toolkit.telemetry.unified", false); // was , locked); // [DEFAULT - Android]
pref("toolkit.telemetry.untrustedModulesPing.frequency", 999999999); // was , locked); // [HIDDEN]
pref("toolkit.telemetry.updatePing.enabled", false); // was , locked); // [HIDDEN - Android]
pref("toolkit.telemetry.user_characteristics_ping.current_version", 0); // was , locked); // [DEFAULT]
pref("toolkit.telemetry.user_characteristics_ping.last_version_sent", 0); // was , locked); // [DEFAULT]
pref("toolkit.telemetry.user_characteristics_ping.logLevel", "Off");
pref("toolkit.telemetry.user_characteristics_ping.opt-out", true); // was , locked);
pref("toolkit.telemetry.user_characteristics_ping.send-once", false); // was , locked); // [DEFAULT]
pref("toolkit.telemetry.user_characteristics_ping.uuid", ""); // was , locked); // [DEFAULT]
pref("urlclassifier.features.emailtracking.datacollection.allowlistTables", ""); // was , locked); // https://searchfox.org/mozilla-central/source/toolkit/components/url-classifier/SafeBrowsing.sys.mjs
pref("urlclassifier.features.emailtracking.datacollection.blocklistTables", ""); // was , locked); // https://searchfox.org/mozilla-central/source/toolkit/components/url-classifier/SafeBrowsing.sys.mjs
...
pref("app.normandy.run_interval_seconds", 0); // was , locked); // [HIDDEN - Android/Thunderbird] Prevent fetching experiments - This pref is also used by Nimbus
pref("app.normandy.api_url", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("app.normandy.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("app.normandy.experiments.lazy_classify", true); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] [DEFENSE IN DEPTH] Prevent making client classification requests on every startup https://mozilla.github.io/normandy/dev/feature-experiments.html
pref("app.normandy.first_run", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("app.normandy.last_seen_buildid", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("app.normandy.logging.level", 70); // [NO-ANDROID] [NO-MAIL] Limit logging to fatal only
pref("app.normandy.user_id", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN]
pref("app.shield.optoutstudies.enabled", false); // was , locked); // [HIDDEN - Android/Thunderbird] Required for Firefox Labs on Desktop
...
pref("nimbus.profileId", ""); // was , locked); // [HIDDEN] https://searchfox.org/mozilla-central/rev/16a9e4fb/toolkit/components/nimbus/ExperimentAPI.sys.mjs#79 - We also set this as a user pref in `phoenix-user-pref.cfg`, to ensure that Firefox properly uses/recognizes it
pref("nimbus.profilesdatastoreservice.enabled", false); // was , locked); // Disable writing to the NimbusEnrollments table database https://searchfox.org/firefox-main/rev/16707ce1/toolkit/components/nimbus/lib/Enrollments.sys.mjs#617
pref("nimbus.profilesdatastoreservice.read.enabled", false); // was , locked); // Disable reading from the NimbusEnrollments table database https://searchfox.org/firefox-main/rev/16707ce1/toolkit/components/nimbus/lib/Enrollments.sys.mjs#628
pref("nimbus.profilesdatastoreservice.sync.enabled", false); // was , locked); // Disable syncing NimbusEnrollments data https://searchfox.org/firefox-main/rev/16707ce1/toolkit/components/nimbus/lib/RemoteSettingsExperimentLoader.sys.mjs#425 https://searchfox.org/firefox-main/rev/16707ce1/toolkit/components/nimbus/lib/Enrollments.sys.mjs#638
...
pref("about.glean.redesign.enabled", false); // was , locked); // [NO-ANDROID] [HIDDEN - non-Desktop Firefox] [DEFAULT]
...
pref("app.distributor", ""); // was , locked); // [HIDDEN] [DEFAULT]
pref("app.distributor.channel", ""); // was , locked); // [HIDDEN] [DEFAULT]
pref("mozilla.partner.id", ""); // was , locked); // [HIDDEN] [DEFAULT]
...
pref("browser.startup.homepage_override.buildID", "20100101"); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] Ex. matches what Tor Browser uses
pref("browser.startup.homepage_override.mstone", "ignore"); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN]
...
pref("browser.dataFeatureRecommendations.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.discovery.enabled", false); // was , locked); // [HIDDEN - Android/Thunderbird] [DEFAULT - Android/Thunderbird]
pref("browser.discovery.sites", ""); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.asrouter.providers.cfr", "null"); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.asrouter.providers.cfr-fxa", "null"); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.asrouter.userprefs.cfr.addons", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.asrouter.userprefs.cfr.features", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.translations.panelShown", true); // was , locked); // [HIDDEN]
...
pref("extensions.recommendations.hideNotice", true); // was , locked); // [HIDDEN] "Some of these recommendations are personalized..." banner
...
pref("doh-rollout._testing", true); // was , locked); // [HIDDEN]
pref("doh-rollout.disable-heuristics", true); // was , locked); // [HIDDEN]
pref("doh-rollout.doneFirstRun", true); // was , locked); // [HIDDEN]
pref("doh-rollout.doorhanger-decision", "UIDisabled"); // was , locked); // [HIDDEN]
pref("doh-rollout.enabled", false); // was , locked); // [HIDDEN]
pref("doh-rollout.mode", 5); // was , locked); // [HIDDEN]
pref("doh-rollout.provider-steering.enabled", false); // was , locked); // [HIDDEN]
pref("doh-rollout.provider-steering.provider-list", ""); // was , locked); // [HIDDEN]
pref("doh-rollout.self-enabled", false); // was , locked); // [HIDDEN]
pref("doh-rollout.skipHeuristicsCheck", true); // was , locked); // [HIDDEN]
pref("doh-rollout.trr-selection.enabled", false); // was , locked); // [HIDDEN]
pref("doh-rollout.trr-selection.provider-list", ""); // was , locked); // [HIDDEN]
pref("doh-rollout.uri", ""); // was , locked); // [HIDDEN]
pref("network.android_doh.autoselect_enabled", false); // was , locked); // [DEFAULT] https://searchfox.org/mozilla-central/rev/f1e32fa7/modules/libpref/init/StaticPrefList.yaml#14585
...
pref("toolkit.contentRelevancy.enabled", false); // was , locked); // [HIDDEN - Android/Thunderbird] [DEFAULT]
pref("toolkit.contentRelevancy.ingestEnabled", false); // was , locked); // [HIDDEN - Android/Thunderbird] [DEFAULT]
pref("toolkit.contentRelevancy.log", false); // [HIDDEN - Android/Thunderbird] [DEFAULT]

/// Disable Mozilla nags/promotions
pref("browser.contentblocking.report.hide_vpn_banner", true); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.contentblocking.report.lockwise.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.contentblocking.report.mobile-android.url", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.contentblocking.report.mobile-ios.url", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.contentblocking.report.monitor.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.contentblocking.report.proxy.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.contentblocking.report.proxy_extension.url", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.contentblocking.report.show_mobile_app", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.contentblocking.report.vpn.url", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.contentblocking.report.vpn-android.url", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.contentblocking.report.vpn-ios.url", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.contentblocking.report.vpn-promo.url", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.ipProtection.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.ipProtection.guardian.endpoint", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.ipProtection.userEnabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.ipProtection.variant", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.privatebrowsing.vpnpromourl", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.promo.cookiebanners.enabled", false); // was , locked); // [HIDDEN - Android/Thunderbird] [DEFAULT - Desktop] https://searchfox.org/firefox-main/rev/dc1c78e9/toolkit/modules/BrowserUtils.sys.mjs#756
pref("browser.promo.focus.enabled", false); // was , locked); // [HIDDEN - Android/Thunderbird] https://searchfox.org/firefox-main/rev/dc1c78e9/toolkit/modules/BrowserUtils.sys.mjs#722
pref("browser.promo.pin.enabled", false); // was , locked); // [HIDDEN - Android/Thunderbird] https://searchfox.org/firefox-main/rev/dc1c78e9/toolkit/modules/BrowserUtils.sys.mjs#734
pref("browser.protections_panel.infoMessage.seen", true); // was , locked); // [NO-ANDROID] [NO-MAIL] Disables ETP Banner
pref("browser.send_to_device_locales", ""); // was , locked); // [HIDDEN - Android/Thunderbird] Disables "Send to Device" email promotions https://searchfox.org/firefox-main/rev/dc1c78e9/browser/app/profile/firefox.js#2503 https://searchfox.org/firefox-main/rev/dc1c78e9/toolkit/modules/BrowserUtils.sys.mjs#789 https://searchfox.org/firefox-main/rev/dc1c78e9/browser/components/preferences/moreFromMozilla.js#273
pref("browser.vpn_promo.enabled", false); // was , locked); // [HIDDEN - Android/Thunderbird] https://searchfox.org/firefox-main/rev/dc1c78e9/toolkit/modules/BrowserUtils.sys.mjs#692
pref("cookiebanners.ui.desktop.showCallout", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("identity.fxaccounts.toolbar.accessed", true); // was , locked); // [NO-ANDROID] [NO-MAIL] Used for Activity Stream/onboarding targeting https://searchfox.org/firefox-main/rev/a7d872e9/browser/components/asrouter/modules/ASRouterTargeting.sys.mjs#98 https://searchfox.org/firefox-main/rev/a7d872e9/browser/components/asrouter/modules/OnboardingMessageProvider.sys.mjs#2506
pref("privacy.trackingprotection.allow_list.hasUserInteractedWithETPSettings", true); // was , locked); // Disables nag/onboarding to configure ETP exception lists https://searchfox.org/firefox-main/rev/dc1c78e9/modules/libpref/init/all.js#3342 https://searchfox.org/firefox-main/rev/dc1c78e9/netwerk/url-classifier/UrlClassifierExceptionListService.sys.mjs#200
pref("sidebar.verticalTabs.dragToPinPromo.dismissed", true); // was , locked); // [NO-ANDROID] [NO-MAIL] Promo card for dragging tabs when vertical tabs are enabled (sidebar.verticalTabs) https://searchfox.org/firefox-main/rev/839a8725/browser/components/sidebar/SidebarManager.sys.mjs#158
pref("trailhead.firstrun.didHandleCampaignAction", true); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] Disable marketing/attribution/"campaign" actions on first run https://searchfox.org/firefox-main/rev/a7d872e9/browser/components/asrouter/modules/ASRouterTargeting.sys.mjs#269 https://searchfox.org/firefox-main/rev/a7d872e9/browser/components/aboutwelcome/actors/AboutWelcomeParent.sys.mjs#271
...
pref("browser.uitour.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.uitour.loglevel", "Off"); // [NO-ANDROID] [NO-MAIL]
pref("browser.uitour.requireSecure", true); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] [DEFAULT]
pref("browser.uitour.surveyDuration", 0); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.uitour.testingOrigins", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] [DEFAULT]
pref("browser.uitour.url", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("dom.origin-trials.private-attribution.state", 2); // was , locked); // [DEFAULT]
pref("dom.private-attribution.submission.enabled", false); // was , locked); // [DEFAULT]
...
pref("browser.search.param.search_rich_suggestions", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.preferences.moreFromMozilla", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.tabs.remote.separatePrivilegedMozillaWebContentProcess", false); // was , locked); // [DEFAULT on Firefox Desktop]
pref("browser.tabs.remote.separatedMozillaDomains", ""); // was , locked);
pref("dom.ipc.processCount.privilegedmozilla", 0); // was , locked);
pref("extensions.webextensions.restrictedDomains", "");
pref("permissions.manager.defaultsUrl", ""); // [HIDDEN - Android] [DEFAULT - Android]
pref("svg.context-properties.content.allowed-domains", ""); // was , locked); // [DEFAULT - Android/Thunderbird]
...
pref("app.releaseNotesURL", "https://www.mozilla.org/firefox/%VERSION%/releasenotes"); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("app.releaseNotesURL.aboutDialog", "https://www.mozilla.org/firefox/%VERSION%/releasenotes"); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("app.releaseNotesURL.prompt", "https://www.mozilla.org/firefox/%VERSION%/releasenotes"); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("app.update.url.details", "https://www.mozilla.org/firefox/notes"); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("app.update.url.manual", "https://www.mozilla.org/firefox/new"); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("datareporting.policy.dataSubmissionPolicyAcceptedVersion", 999); // was , locked);
pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "32503679999000"); // was , locked);
pref("termsofuse.acceptedDate", "32503679999000"); // was , locked); // [HIDDEN - Android/Thunderbird] [NIGHTLY]
pref("termsofuse.acceptedVersion", 999); // was , locked); // [HIDDEN - Android/Thunderbird] [NIGHTLY]
pref("termsofuse.bypassNotification", true); // was , locked); // [HIDDEN - Android/Thunderbird] [DEFAULT - builds without MOZILLA_OFFICIAL] [NIGHTLY]
...
pref("browser.contentblocking.category", "strict"); // was , locked); // [HIDDEN]
...
pref("privacy.trackingprotection.allow_list.hasMigratedCategoryPrefs", true); // was , locked); // Skip migration, so that `privacy.trackingprotection.allow_list.baseline.enabled` isn't overriden to `false` https://searchfox.org/firefox-main/rev/dc1c78e9/netwerk/url-classifier/UrlClassifierExceptionListService.sys.mjs#254
...
pref("security.tls.version.enable-deprecated", false); // was , locked); // [DEFAULT]
...
pref("network.parental_controls_cached_state", false); // was , locked); // [DEFAULT]
pref("security.restrict_to_adults.always", false); // was , locked); // [DEFAULT]
pref("security.restrict_to_adults.respect_platform", false); // was , locked); // [DEFAULT]
...
pref("security.certerrors.mitm.auto_enable_enterprise_roots", false); // was , locked); // [NO-ANDROID] [HIDDEN - Thunderbird]
pref("security.enterprise_roots.enabled", false); // was , locked); // [NO-ANDROID]
...
pref("dom.security.https_only_mode", true); // was , locked); // [NO-ANDROID] [NO-MAIL] Locked for Desktop due to being a critical privacy/security feature, but not locked for Android/Thunderbird since it's unfortunately not yet possible to add exceptions there - https://gitlab.com/ironfox-oss/IronFox/-/issues/48
pref("dom.security.https_only_mode.upgrade_local", true);
pref("dom.security.https_only_mode_pbm", true);
pref("dom.security.https_only_mode_pbm", true); // was , locked); // [NO-ANDROID] [NO-MAIL] Locked for Desktop due to being a critical privacy/security feature, but not locked for Android/Thunderbird since it's unfortunately not yet possible to add exceptions there - https://gitlab.com/ironfox-oss/IronFox/-/issues/48
...
pref("browser.urlbar.tipShownCount.searchTip_onboard", 999); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] Onboarding search tip https://searchfox.org/mozilla-central/rev/874c5067/browser/components/urlbar/UrlbarPrefs.sys.mjs#516
pref("browser.urlbar.tipShownCount.searchTip_redirect", 999); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] Redirect search tip https://searchfox.org/mozilla-central/rev/874c5067/browser/components/urlbar/UrlbarPrefs.sys.mjs#519
...
pref("xpinstall.whitelist.add", ""); // was , locked); // [HIDDEN - non-Android] [DEFAULT - non-Android]
...
pref("extensions.autoDisableScopes", 15); // was , locked); // [DEFAULT - non-Thunderbird] Defense in depth, ensures sideloaded extensions are always disabled by default...
...
pref("extensions.postDownloadThirdPartyPrompt", false); // was , locked); // [HIDDEN - Android/Thunderbird] https://github.com/arkenfox/user.js/issues/1090
...
pref("xpinstall.whitelist.required", true); // was , locked); // [DEFAULT] This is the `Warn you when websites try to install add-ons` setting at `about:preferences#privacy`
...
pref("extensions.quarantineIgnoredByUser.adb@mozilla.org", false); // was , locked); // Firefox DevTools ADB Extension
pref("extensions.quarantineIgnoredByUser.ads@mozac.org", false); // was , locked); // Mozilla Android Components - Ads Telemetry
pref("extensions.quarantineIgnoredByUser.ATBC@EasonWong", false); // Adaptive Tab Bar Color
pref("extensions.quarantineIgnoredByUser.cookies@mozac.org", false); // was , locked); // Mozilla Android Components - Search Telemetry
...
pref("extensions.quarantineIgnoredByUser.ddg@search.mozilla.org", false); // was , locked); // DuckDuckGo - search engine
...
pref("extensions.quarantineIgnoredByUser.wikipedia@search.mozilla.org", false); // was , locked); // Wikipedia (en) - search engine
...
pref("devtools.aboutdebugging.showHiddenAddons", true); // was , locked); // [NO-ANDROID]
...
pref("browser.safebrowsing.provider.google.dataSharing.enabled", false); // was , locked); // [HIDDEN - non-Android] [DEFAULT]
pref("browser.safebrowsing.provider.google.dataSharingURL", ""); // was , locked); // [HIDDEN] [DEFAULT]
pref("browser.safebrowsing.provider.google4.dataSharing.enabled", false); // was , locked); // [DEFAULT]
pref("browser.safebrowsing.provider.google4.dataSharingURL", ""); // was , locked);
pref("browser.safebrowsing.provider.google5.dataSharing.enabled", false); // was , locked); // [HIDDEN] [DEFAULT]
pref("browser.safebrowsing.provider.google5.dataSharingURL", ""); // was , locked); // [HIDDEN] [DEFAULT]
pref("browser.safebrowsing.provider.mozilla.dataSharing.enabled", false); // was , locked); // [HIDDEN] [DEFAULT]
pref("browser.safebrowsing.provider.mozilla.dataSharingURL", ""); // was , locked); // [HIDDEN] [DEFAULT]
pref("browser.safebrowsing.provider.test.dataSharing.enabled", false); // was , locked); // [HIDDEN] [DEFAULT]
pref("browser.safebrowsing.provider.test.dataSharingURL", ""); // was , locked); // [HIDDEN] [DEFAULT]
...
pref("dom.events.testing.asyncClipboard", false); // was , locked); // [DEFAULT]
...
pref("browser.contentanalysis.default_result", 0); // was , locked); // [DEFAULT]
pref("browser.contentanalysis.enabled", false); // was , locked); // [DEFAULT]
pref("browser.contentanalysis.interception_point.clipboard.enabled", false); // was , locked);
pref("browser.contentanalysis.interception_point.drag_and_drop.enabled", false); // was , locked);
pref("browser.contentanalysis.interception_point.file_upload.enabled", false); // was , locked);
pref("browser.contentanalysis.interception_point.print.enabled", false); // was , locked);
pref("browser.contentanalysis.max_connections", 0); // was , locked); // Sets maximum number of allowed connections to 0
pref("browser.contentanalysis.show_blocked_result", true); // was , locked); // [DEFAULT] - Always notify users when Content Analysis blocks access to something...
pref("browser.contentanalysis.silent_notifications", false); // was , locked); // [DEFAULT] If Content Analysis is enabled, ensure notifications aren't silenced so that users are fully aware
...
pref("autoadmin.append_emailaddr", false); // was , locked); // [HIDDEN] [DEFAULT]
...
pref("security.default_personal_cert", "Ask Every Time"); // was , locked); // [DEFAULT]
...
pref("network.protocol-handler.external.shell", false); // was , locked); // [DEFAULT]
...
pref("general.config.sandbox_enabled", true); // was , locked); // [HIDDEN] [DEFAULT]
...
pref("security.turn_off_all_security_so_that_viruses_can_take_over_this_computer", false); // was , locked); // [HIDDEN] [DEFAULT]
...
pref("browser.disableResetPrompt", true); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN]
...
pref("devtools.debugger.prompt-connection", true); // was , locked); // [DEFAULT - non-Nightly]
...
pref("devtools.debugger.remote-websocket", false); // was , locked); // [DEFAULT]
...
pref("remote.experimental.enabled", false); // was , locked); // [DEFAULT - non-Nightly]
...
pref("devtools.debugger.force-local", true); // was , locked); // [DEFAULT]
pref("devtools.inspector.remote", false); // was , locked); // [NO-ANDROID] [DEFAULT]
...
pref("remote.system-access-check.enabled", true); // was , locked); // [HIDDEN] [DEFAULT]
...
// pref("browser.uiCustomization.state", '{"placements":{"widget-overflow-fixed-list":["developer-button","screenshot-button"],"unified-extensions-area":["ublock0_raymondhill_net-browser-action","sponsorblocker_ajay_app-browser-action","_3c078156-979c-498b-8990-85f7987dd929_-browser-action","addon_darkreader_org-browser-action","_aecec67f-0d10-4fa7-b7c7-609a2db280cf_-browser-action"],"nav-bar":["back-button","forward-button","vertical-spacer","stop-reload-button","urlbar-container","_testpilot-containers-browser-action","reset-pbm-toolbar-button","search-container","home-button","unified-extensions-button","bookmarks-menu-button","zoom-controls","fullscreen-button","downloads-button"],"toolbar-menubar":["menubar-items"],"TabsToolbar":["tabbrowser-tabs","new-tab-button"],"vertical-tabs":[],"PersonalToolbar":["personal-bookmarks"]},"seen":["reset-pbm-toolbar-button","developer-button","_testpilot-containers-browser-action","ublock0_raymondhill_net-browser-action","screenshot-button","addon_darkreader_org-browser-action","_3c078156-979c-498b-8990-85f7987dd929_-browser-action","_aecec67f-0d10-4fa7-b7c7-609a2db280cf_-browser-action","sponsorblocker_ajay_app-browser-action"],"dirtyAreaCache":["nav-bar","vertical-tabs","PersonalToolbar","unified-extensions-area","TabsToolbar","toolbar-menubar","widget-overflow-fixed-list"],"currentVersion":23,"newElementCount":13}');
...
pref("browser.topsites.contile.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] https://searchfox.org/mozilla-central/rev/7d68baf8/toolkit/components/nimbus/FeatureManifest.yaml#909
pref("browser.topsites.contile.endpoint", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.topsites.contile.sov.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] https://searchfox.org/mozilla-central/rev/7d68baf8/toolkit/components/nimbus/FeatureManifest.yaml#1794
...
pref("browser.urlbar.quicksuggest.impressionCaps.nonSponsoredEnabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.urlbar.quicksuggest.impressionCaps.sponsoredEnabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
...
pref("browser.newtabpage.activity-stream.discoverystream.reportAds.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] [NIGHTLY]
pref("browser.newtabpage.activity-stream.discoverystream.sections.contextualAds.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.sections.contextualAds.locale-config", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.discoverystream.sections.contextualAds.region-config", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.feeds.adsfeed", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.unifiedAds.adsFeed.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.unifiedAds.adsFeed.spocs.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.unifiedAds.adsFeed.tiles.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.unifiedAds.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.unifiedAds.endpoint", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.unifiedAds.spocs.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.unifiedAds.tiles.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.newtabpage.activity-stream.asrouter.providers.message-groups", "null"); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.asrouter.providers.messaging-experiments", "null"); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.asrouter.providers.onboarding", "null"); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.asrouter.providers.snippets", "null"); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.feeds.newtabmessaging", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("messaging-system.askForFeedback", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.newtabpage.activity-stream.mobileDownloadModal.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] [NIGHTLY]
pref("browser.newtabpage.activity-stream.mobileDownloadModal.variant-a", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] [NIGHTLY]
pref("browser.newtabpage.activity-stream.mobileDownloadModal.variant-b", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] [NIGHTLY]
pref("browser.newtabpage.activity-stream.mobileDownloadModal.variant-c", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] [NIGHTLY]
...
pref("browser.newtabpage.activity-stream.discoverystream.onboardingExperience.dismissed", true); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.discoverystream.onboardingExperience.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.discoverystream.topicSelection.onboarding.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.topicSelection.onboarding.maybeDisplay", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.newtabpage.activity-stream.discoverystream.ctaButtonSponsors", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.placements.spocs", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.discoverystream.placements.spocs.counts", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.discoverystream.spocs-endpoint", "data;"); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.spocs-endpoint-query", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.spocAdTypes", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.spocMessageVariant", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.spocSiteId", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.sponsored-collections.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.endpointSpocsClear", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] Ensure we don't try to send a deletion request, as there's no data to delete... and we block the endpoint anyways https://searchfox.org/mozilla-central/rev/7d68baf8/browser/extensions/newtab/docs/v2-system-addon/preferences.md#128
pref("browser.newtabpage.activity-stream.discoverystream.region-spocs-config", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] Don't show sponsored content to any region by default... https://searchfox.org/mozilla-central/rev/96296f9d/toolkit/components/nimbus/FeatureManifest.yaml#1769
pref("browser.newtabpage.activity-stream.discoverystream.spoc-positions", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.showSponsored", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.system.showSponsored", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.newtabpage.activity-stream.discoverystream.promoCard.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [NIGHTLY] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.promoCard.visible", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [NIGHTLY]
...
pref("browser.newtabpage.activity-stream.discoverystream.spoc-topsites-positions", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.discoverystream.spocTopsitesAdTypes", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.spocTopsitesPlacement.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.discoverystream.spocTopsitesZoneIds", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.spocZoneIds", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.showSponsoredTopSites", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.contextual-services.contextId", "{foo-123-foo}"); // was , locked); // [NO-ANDROID] [NO-MAIL] https://searchfox.org/mozilla-central/source/browser/extensions/newtab/test/xpcshell/test_TelemetryFeed.js
pref("browser.newtabpage.activity-stream.feeds.telemetry", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.telemetry", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.telemetry.privatePing.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] [NIGHTLY]
pref("browser.newtabpage.activity-stream.telemetry.privatePing.inferredInterests.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] [NIGHTLY] Ensure we never submit "inferred" New Tab interests with new tab pings
pref("browser.newtabpage.activity-stream.telemetry.privatePing.redactNewtabPing.enabled", true); // was , locked); // [NO-ANDROID] [NO-MAIL] [NIGHTLY] Redact information from new tab pings https://searchfox.org/mozilla-central/source/browser/extensions/newtab/lib/TelemetryFeed.sys.mjs#354
pref("browser.newtabpage.activity-stream.telemetry.structuredIngestion.endpoint", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.telemetry.surfaceId", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] [NIGHTLY]
pref("browser.newtabpage.activity-stream.telemetry.ut.events", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.ping.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN]
pref("browser.places.interactions.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] Disable interaction measurements https://searchfox.org/mozilla-central/source/browser/components/places/Interactions.sys.mjs
...
pref("browser.privacySegmentation.preferences.show", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.search.serpEventTelemetryCategorization.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.search.serpEventTelemetryCategorization.regionEnabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] [DEFAULT]
pref("browser.search.serpMetricsRecordedCounter", 0); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] Ensure we never try to submit SERP categorization event metrics https://searchfox.org/mozilla-central/rev/584b3448/browser/app/profile/firefox.js#827
...
pref("browser.newtabpage.activity-stream.showSponsoredCheckboxes", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN]
pref("browser.newtabpage.activity-stream.system.showSponsoredCheckboxes", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN]
...
pref("browser.newtabpage.activity-stream.discoverystream.personalization.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.discoverystream.recs.personalized", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.sections.personalization.inferred.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.sections.personalization.inferred.locale-config", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.discoverystream.sections.personalization.inferred.region-config", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.sections.personalization.inferred.user.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.discoverystream.shortcuts.personalization.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.newtabpage.activity-stream.discoverystream.spocs.personalized", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.feeds.inferredpersonalizationfeed", false); // was , locked); // [NO-ANDROID] [NO-MAIL]

/// If stories are enabled, disable impression tracking [NO-ANDROID] [NO-MAIL]
pref("browser.newtabpage.activity-stream.impressionId", "{some-fake-impression-ID}"); // was , locked); // [NO-ANDROID] [NO-MAIL] https://searchfox.org/mozilla-central/source/browser/extensions/newtab/test/xpcshell/test_TelemetryFeed.js
pref("browser.newtabpage.activity-stream.discoverystream.rec.impressions", "{}"); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] https://searchfox.org/mozilla-central/rev/cc4985b7/browser/extensions/newtab/lib/ActivityStream.sys.mjs#978
pref("browser.newtabpage.activity-stream.discoverystream.spoc.impressions", "{}"); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT] https://searchfox.org/mozilla-central/rev/cc4985b7/browser/extensions/newtab/lib/ActivityStream.sys.mjs#962
pref("browser.newtabpage.activity-stream.feeds.section.topstories.rec.impressions", "{}"); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] https://searchfox.org/mozilla-central/rev/cc4985b7/browser/extensions/newtab/lib/TopStoriesFeed.sys.mjs#33
pref("browser.newtabpage.activity-stream.feeds.section.topstories.spoc.impressions", "{}"); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN] https://searchfox.org/mozilla-central/rev/cc4985b7/browser/extensions/newtab/lib/TopStoriesFeed.sys.mjs#27
...
pref("browser.urlbar.amp.featureGate", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.urlbar.suggest.amp", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.urlbar.exposureResults", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN]
pref("browser.urlbar.keywordExposureResults", ""); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN]
pref("browser.urlbar.showExposureResults", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [HIDDEN]
...
pref("browser.urlbar.quicksuggest.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.urlbar.suggest.realtimeOptIn", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.partnerlink.attributionURL", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("browser.partnerlink.campaign.topsites", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("browser.urlbar.sponsoredTopSites", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
...
pref("browser.urlbar.quicksuggest.contextualOptIn", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
pref("browser.urlbar.quicksuggest.dataCollection.enabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL] [DEFAULT]
...
pref("identity.fxaccounts.toolbar.pxiToolbarEnabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("identity.fxaccounts.toolbar.pxiToolbarEnabled.monitorEnabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("identity.fxaccounts.toolbar.pxiToolbarEnabled.relayEnabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("identity.fxaccounts.toolbar.pxiToolbarEnabled.vpnEnabled", false); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("identity.mobilepromo.android", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("identity.mobilepromo.ios", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
pref("identity.sendtabpromo.url", ""); // was , locked); // [NO-ANDROID] [NO-MAIL]
...
pref("identity.fxaccounts.toolbar.syncSetup.panelAccessed", true); // was , locked); // [NO-ANDROID] [NO-MAIL]

/// Disable telemetry [NO-ANDROID]
pref("identity.fxaccounts.account.telemetry.sanitized_uid", ""); // was , locked); // [NO-ANDROID]
pref("identity.fxaccounts.telemetry.clientAssociationPing.enabled", false); // was , locked); // [NO-ANDROID]
pref("services.sync.log.logger.telemetry", "Fatal"); // [NO-ANDROID] [HIDDEN]
pref("services.sync.telemetry.maxEventsCount", 0); // was , locked); // [NO-ANDROID] [HIDDEN] Disable `sync` ping https://searchfox.org/mozilla-central/source/toolkit/components/telemetry/docs/data/sync-ping.rst
pref("services.sync.telemetry.maxPayloadCount", 0); // was , locked); // [NO-ANDROID] Disable `sync` ping https://searchfox.org/mozilla-central/source/toolkit/components/telemetry/docs/data/sync-ping.rst
pref("services.sync.telemetry.submissionInterval", 999999999); // was , locked); // [NO-ANDROID] Disable `sync` ping https://searchfox.org/mozilla-central/source/toolkit/components/telemetry/docs/data/sync-ping.rst
...
pref("browser.phoenix.status", "successfully applied :D"); // was , locked);
