...
Singleton {
    property color backgroundColor: "#241E23"
    property color foregroundColor: "#F8F0D8"
    property color indicatorBGColor: "#f0bb90"
    property color borderColor: "#241E23"
    property color moduleBG: "#241E23"
    property color accentColor: "#3A3539"
    property color accent2Color: "#3A3539"
