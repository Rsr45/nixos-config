...
Singleton {
    property string font: "Iosevka"
    property string icon: "Iosevka Nerd Font Propo"
    property string mono: "Geist Mono"
    ...
    readonly property int barMarginBottom: 10
    readonly property int barMarginLeft: 10
    readonly property int barMarginRight: 10
