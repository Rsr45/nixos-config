...
Rectangle {
    ...
    // ───── Top usage bar (now horizontal strip) ─────
    Rectangle {
        id: indicatorTrack
        ...
        Rectangle {
            ...
            width: parent.width * Math.min(SystemUsage.memPerc, 1.0)
    ...
    RowLayout {
        ...
        Text {
            text: "MEM: " + Math.round(SystemUsage.memPerc * 100) + "%"
            font.pixelSize: 16
